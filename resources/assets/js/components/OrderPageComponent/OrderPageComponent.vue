                            ...
                            <slick ref="slick" :options="slickOptions">
                                ...
                                <div class="slider-order__slide">
                                    ...
                                    <div class="slider-order__row slider-order__row-center">
                                        ...
                                        <label for="agree-checked" class="checked-block__label">I have read and agree
                                            with
                                            <a
                                                    class="slider-order__href" href="#">rules &amp;
                                                regulations</a></label>
                        ...
                        <div class="usspi-block" id="usspi-block">
                            <form action="" id="usspi-form">
                                ...
                                <div class="usspi-block__content">
                                    <div class="content-authorize">I, <input class="inp-content"
                                                                             name="firstExporterName"><input
                                            class="inp-content" name="secondExporterName">, authorize
                                    </div>
